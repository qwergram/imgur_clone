    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.CharField(choices=[('CLOSED', 'Private'), ('UNLISTED', 'Shared'), ('OPEN', 'Public')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.CharField(choices=[('CLOSED', 'Private'), ('UNLISTED', 'Shared'), ('OPEN', 'Public')], default='OPEN', max_length=255)),
                ('date_uploaded', models.DateTimeField(auto_now_add=True, null=True)),
                ('date_modified', models.DateTimeField(auto_now=True, null=True)),
                ('date_published', models.DateTimeField(blank=True, null=True)),
                ('photo', models.ImageField(upload_to=imager_images.models.image_path)),
